  ...
  return (
    <>
      <section className="area">
        <div>
          <div className="font-[base] font-normal mobile:text-md tablet:text-4xl text-center break-keep leading-[1.5] section1" ref={section1Ref}>
          ...
          <div
            className="flex mobile:flex-col tablet:flex-row mx-auto mt-20 mobile:w-full mobile:text-center tablet:text-left tablet:w-min font-[base] font-light text-sm items-start gap-5 "
            ref={section2Ref}
          >
            <div className="flex items-center gap-5 mobile:flex-col tablet:flex-row mobile:justify-center tablet:justify-start mobile:w-full tablet:w-min">
              <h2 className="whitespace-nowrap font-medium ani1">01. 이곳에 오기까지</h2>
              <span className="w-20 border-t-[1px] border-black ani2"></span>
            </div>
            <p className="break-keep mobile:w-full tablet:w-[30rem] ani3">
      ...
      <section className="grid mobile:grid-cols-1 tablet:grid-cols-[2.5fr_1fr_1fr] gap-3 my-20 mobile:h-auto tablet:h-[50rem] grid-rows-2" ref={section3Ref}>
        ...
        <div className="bg-neutral-100 relative p-10 item">
          ...
          <div className="absolute mobile:right-10 tablet:left-10 bottom-10  mobile:text-5xl tablet:text-8xl font-bold font-[base]">{getCount}+</div>
        </div>
        <div className="bg-neutral-800 text-white p-10 relative item">
          ...
          <div className="absolute mobile:right-10 tablet:left-10 bottom-10 mobile:text-5xl tablet:text-8xl font-bold font-[base]">{projects.length}+</div>
        </div>
        <div className="item">
      ...
      <section className="area border-t-[1px] border-gray-200" ref={skillRef}>
        <div>
          <div className="grid mobile:grid-cols-1 tablet:grid-cols-2 items-end py-20">
            ...
            <p className="font-[base] mobile:w-full tablet:w-100 break-keep justify-self-end text">
              웹 퍼블리싱과 프론트엔드 개발을 경험하고, 효율적이고 유지보수하기 쉬운 웹 환경 구축에 집중해 왔습니다. 더 나은 사용자 경험을 위해 지속적으로 학습하며, 새로운 기술과 트렌드에 열린 자세로
              임하고 있습니다.
            </p>
            <ul className="grid mobile:grid-cols-1 tablet:grid-cols-3 gap-x-30 gap-y-20 col-span-full mt-15 font-[base] skills">
          ...
          <div className="pb-20 mt-20 text-center">
            <ul className="mobile:block tablet:inline-grid grid-cols-5 grid-rows-3 sns">
              <li aria-hidden></li>
              <li className="col-start-3 col-end-6 self-center p-15 font-[base] mobile:text-center tablet:text-left">저와 함께 성장해보세요.</li>
                ...
                return (
                  <li key={index} className={classSet(index) + " font-[base] group"}>
                    <a
                      ...
                      target="_blank"
                      className={
                        "transition-all duration-300 text-gray-500 border-gray-300 border-[1px] mobile:py-5 tablet:py-0 tablet:aspect-square mobile:w-full tablet:w-50 flex flex-col justify-center items-center text-light " +
      ...
      <section className="bg-black py-20 text-white relative z-50">
        <div className="mx-auto w-[90vw] grid mobile:grid-cols-[repeat(auto-fill,minmax(2rem,1fr))] tablet:grid-cols-[repeat(auto-fill,minmax(4rem,1fr))] gap-10 justify-center items-center">
